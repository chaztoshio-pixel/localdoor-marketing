...
export const metadata: Metadata = pageMeta({
  title: "EDDM Print & Mail Services",
  description:
    "Route-level EDDM print and mail. Search a market, estimate households, upload artwork, and request a managed campaign quote.",
  path: "/eddm-print-and-mail",
});
